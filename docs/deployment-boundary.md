...
| `DEFAULT_RUNNER_LABEL`             | `lcars-default`                                                                      | manual agent-router fallback, agent-automerge, label-contract-audit, deploy-console — small, fast glue jobs only (#451)      |
...
| `GCP_DISPATCH_BROKER_WIF_PROVIDER` | `projects/611425338852/…/workloadIdentityPools/dispatch-controller/providers/github` | manual agent-router fallback only; provider accepts `agent-router.yml` from `main`                                           |
...
| `GCP_DISPATCH_BROKER_SA`           | `dispatch-broker@agent-lcars…`                                                       | manual agent-router fallback writes only                                                                                     |
...
| `DISPATCH_FIRESTORE_DATABASE_ID`   | `dispatch-controller`                                                                | hosted controller, manual agent-router fallback, and worker preflight                                                        |
| `DISPATCH_AUTHORITY_EPOCH`         | cutover timestamp in ISO 8601                                                        | authority initialization boundary                                                                                            |
