...
[{"id":"ses_current","title":"current","directory":"$workspace","updated":1786147800000,"created":1786147700000},{"id":"ses_nested","title":"nested","directory":"$workspace","time":{"updated":1786147800000}},{"id":"ses_old","title":"old","directory":"$workspace","updated":1786140000000},{"id":"ses_other","title":"other","directory":"/other","updated":1786147800000}]
JSON
...
test -f "$archive_dir/sessions/ses_nested.json"
...
jq -e '
  ...
  .run_id == "12345" and
  .issue == "523" and
  .selected_sessions == 2 and
  .exported_sessions == 2 and
